...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col font-sans">
            ...
            {/* Top Banner */}
            <div className="w-full bg-gradient-to-r from-[#064E3B] to-[#0a6c52] text-white py-8 px-6 sm:px-10 shadow-md rounded-none mb-10">
            ...
            <main className="flex-1 w-full px-6 sm:px-10 pb-16">
                <div className="w-full bg-white rounded-3xl p-6 sm:p-10 shadow-lg border border-[#064E3B]/10 space-y-10">
                    ...
                    <div className="pt-4 border-t border-gray-100">
                        <h2 className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-4">Add New Task</h2>
